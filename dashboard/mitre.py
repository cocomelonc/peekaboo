...
TTP_IMPLEMENTATIONS: list[tuple[str, str, str, str, str]] = [
    ...
    # -- Evasion -------------------------------------------------------------
    ("T1027",     "simple-malware-av-evasion",   "",                            "windows",
     "In-memory payload execution to avoid disk-based signatures"),
    ("T1027",     "simple-malware-av-evasion-2", "av-evasion-2",                "windows",
     "XOR-encoded payload decoded and executed in memory"),
    ("T1027",     "simple-malware-av-evasion-3", "simple-malware-av-evasion-3", "windows",
     "Oversized memory allocation to slow AV scanning"),
    ("T1027",     "simple-malware-av-evasion-4", "malware-av-evasion-4",        "windows",
     "Obfuscated API resolution through export ordinals"),
    ("T1027",     "simple-av-evasion-5",         "malware-av-evasion-5",        "windows",
     "Dynamic API resolution with hashed function names"),
    ...
    # The published series jumps from part 1 to part 20.
    ...
    # -- Tricks / misc -------------------------------------------------------
    # The published tricks series starts at part 22.
    ...
    # Parts 32 and 33 were never published.
    ("T1055",     "malware-tricks-34", "malware-tricks-34", "windows",
     "Ghost injection via NtCreateProcessEx"),
    ("T1057",     "malware-trick-36", "malware-trick-36", "windows",
     "Enumerate loaded process modules with Toolhelp snapshots"),
    ("T1057",     "malware-trick-37", "malware-trick-37", "windows",
     "Enumerate loaded process modules with VirtualQueryEx"),
    ("T1055",     "malware-trick-38", "malware-trick-38", "windows",
     "Find RWX memory regions in target processes for payload execution"),
    ("T1055.004", "malware-trick-39", "malware-trick-39", "windows",
     "Execute shellcode through an EnumDesktopsA callback"),
    ("T1567",     "malware-trick-42", "malware-trick-42", "windows",
     "Exfiltrate data through the Discord Bot API"),
    ("T1027",     "malware-trick-43", "malware-trick-43", "windows",
     "Shuffle payload bytes to evade static signatures"),
